        ...
        <div data-aos="fade-up" data-aos-duration="3000">
            <div className="flex text-center">
                <div className="w-1/2">
                    ...
                    <h1 className="text-7xl font-serif">Meet our top<br></br>
                        clients & partners</h1>
                </div>
                <div className="w-1/2 text-zinc-400 p-10">
            ...
            <div className="mt-32 mb-12">
                ...
                <div className="mx-auto flex justify-center gap-20">
                    <img src={'https://i.ibb.co/w0yKNh1/cl4-copyright.webp'} alt="" />
                    <img src={'https://i.ibb.co/YbbmccR/cl3-copyright.webp'} alt="" />
                    <img src={'https://i.ibb.co/BfT6XGF/cl1-copyright.webp'} alt="" />
                    <img src={'https://i.ibb.co/6msLG4K/cl5-copyright.webp'} alt="" />
                </div>
            </div>
        </div>
    );
